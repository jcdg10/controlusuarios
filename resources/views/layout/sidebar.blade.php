    ...
    <div class="wrapper">
        ...
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item">
            <a class="nav-link" href="{{ route('logout.perform') }}" role="button">
              <i class="fa-solid fa-square-xmark"></i> Cerrar sesión
            </a>
          </li>
          <li class="nav-item">
      ...
      <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <a href="index3.html" class="brand-link">
          <img src="{{ URL::to('/') }}/dist/img/JulioLogo.PNG" alt="LDG Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
          <span class="brand-text font-weight-light">Julio Delgado</span>
        </a>
